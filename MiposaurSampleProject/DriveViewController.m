...
#import <WowWeeMiPosaurSDK/WowWeeMiPosaurSDK.h>
...
@property (strong, nonatomic) MiposaurRobot *miposaur;
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    self.miposaur = [[MiposaurRobotFinder sharedInstance] firstConnectedMiposaur];
...
- (void)joystickTimerCallback {
    if(self.movementVector.dx != 0 || self.movementVector.dy != 0){
        [self.miposaur miposaurDrive:self.movementVector];
    }
}
